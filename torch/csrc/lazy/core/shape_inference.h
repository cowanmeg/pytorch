...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_repeat_interleave(const at::Tensor & self, const at::Tensor & repeats, c10::optional<int64_t> dim, c10::optional<int64_t> output_size);
